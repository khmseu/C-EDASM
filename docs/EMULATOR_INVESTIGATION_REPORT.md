...
# Inject test sources
diskm8 inject test_sources.2mg test_simple.src
diskm8 inject test_sources.2mg test_expressions.src
...
./build/edasm_cli test_simple.src -o /tmp/cedasm_output.bin
