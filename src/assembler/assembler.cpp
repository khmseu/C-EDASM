...
bool Assembler::process_conditional_directive_pass1(const SourceLine& line, Result& result) {
    ...
    if (mnem == "IFNE") {
        ...
        if (!eval_result.success) {
            add_error(result, "Invalid expression in " + mnem + ": " + eval_result.error_message, line.line_number);
            return false;
        }
    ...
    if (mnem == "IFEQ") {
        ...
        if (!eval_result.success) {
            add_error(result, "Invalid expression in IFEQ: " + eval_result.error_message, line.line_number);
            return false;
        }
    ...
    if (mnem == "IFGT") {
        ...
        if (!eval_result.success) {
            add_error(result, "Invalid expression in IFGT: " + eval_result.error_message, line.line_number);
            return false;
        }
    ...
    if (mnem == "IFGE") {
        ...
        if (!eval_result.success) {
            add_error(result, "Invalid expression in IFGE: " + eval_result.error_message, line.line_number);
            return false;
        }
    ...
    if (mnem == "IFLT") {
        ...
        if (!eval_result.success) {
            add_error(result, "Invalid expression in IFLT: " + eval_result.error_message, line.line_number);
            return false;
        }
    ...
    if (mnem == "IFLE") {
        ...
        if (!eval_result.success) {
            add_error(result, "Invalid expression in IFLE: " + eval_result.error_message, line.line_number);
            return false;
        }
