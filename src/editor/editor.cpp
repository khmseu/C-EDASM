...
Editor::FindResult Editor::find(const std::string& pattern, const LineRange& range, int start_line) {
    FindResult result;
...
int Editor::change(const std::string& old_text, const std::string& new_text, 
                   const LineRange& range, bool all) {
